<template>
  <div
    class="login-form-account bg-green-light w-screen h-screen flex items-center justify-center"
  >
    <div
      class="formLogin-account flex items-center justify-center bg-white-default container mx-auto p-10 rounded-3xl"
    >
      <div class="flex flex-col items-center justify-center w-1/2">
        <!-- <div class="flex">
          ...
          <span class="text-green-dark text-lg font-[500]"
          ...
          <form action="#">
            <div class="phoneNumber flex flex-col">
              ...
              <input
                type="text"
                placeholder="98+"
                class="bg-white-default outline-none rounded-lg px-2 text-left"
              />
            </div>
            <div class="password flex flex-col">
              ...
              <input
                type="password"
                placeholder=""
                class="bg-white-default outline-none px-2 rounded-lg"
              />
            </div>
            <button
