<template>
  <div class="container ">
    <div class="content flex justify-center py-18 w-screen h-screen">
      <!-- <div class="w-1/5">
        <ownerBox/>
      </div> -->
      <div class="showTurnRatings w-2/3 ">
        <HeaderTurnRating class="rounded-t-3xl"/>
...
import ownerBox from "../components/ownerBox.vue"
