    ...
    >
      <form>
        ...
        <div class="btn-submit">
          ...
          <router-link to="/turnRatings">  <button class="w-full bg-red-500 p-1 text-white mt-8 rounded-lg" @submit.prevent="redirectToTurnRatings()">
            ادامه
          </button></router-link>
        </div>
      </form>
...
const router = useRouter()
    ...
    const redirectToTurnRatings = () =>{
      console.log('redirectToTurnRatingsredirectToTurnRatingsredirectToTurnRatingsredirectToTurnRatings');
