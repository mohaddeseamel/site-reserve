<template>
  <div class="containe-header w-screen px-11 py-5 max-h-80">
    <div class="header flex justify-between items-center">
      <div class="userAccount px-12">
        <button class="account-style rounded-full px-6 py-3 text-sm bg-white">
          حساب کاربری
        </button>
      </div>
      <div class="header-logo px-12 flex items-center justify-end text-center">
        <h1 class="logo-title text-2xl font-[500]">Colorful Beauty</h1>
        <svg
