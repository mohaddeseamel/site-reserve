<template>
  <div class="showUserStylish bg-white-default">
    <h1 class="title text-start p-5 font-yekan bg-white-default text-lg text-gray-default">
      لیست آرایشگران
    </h1>
    <div class="stylist-card flex px-5">
      ...
      >
        <swiper-slide
          class="card border-2 p-5 text-center border-gray-lighten rounded-3xl cursor-pointer"
        ...
        >
          ...
          <div class="star flex justify-center mt-3">
            ...
            <span class="mr-2 text-fontColor-brown">{{ user.star }}</span>
          </div>
        </swiper-slide>
      </swiper>
    </div>
